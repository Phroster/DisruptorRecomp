...
This download contains **no part of the game**. You need your own copy of Disruptor.
...
- 🎯 Smooth 60 fps at the original game speed
- 🖥️ Real 16:9 widescreen that shows more of the world
- 🖱️ Mouse look, WASD, mouse-wheel weapon switching, controller support
- 🔍 Up to 4× resolution, no wobbling polygons or warping textures
- 🎬 Bigger, smoother cutscenes
- 💾 Savestates on **F7**
- ⚙️ A launcher with every setting and full key rebinding

### 🤝 Help us test

This is a release candidate. Please play, and
[report anything that goes wrong](https://github.com/Phroster/DisruptorRecomp/issues) with the logs from the
launcher's **Logs folder**. Hearing that levels play fine is just as useful!
